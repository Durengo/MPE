...
namespace MPE
{
    OrthographicCameraController::OrthographicCameraController(float aspectRatio, bool rotation)
        : ASPECT_RATIO(aspectRatio), CAMERA(-ASPECT_RATIO * ZOOM_LEVEL, ASPECT_RATIO * ZOOM_LEVEL, -ZOOM_LEVEL, ZOOM_LEVEL), ROTATION(rotation),
          CAMERA_DEFAULT_SPEEDS{
              // CAMERA MOVEMENT SPEED
              1.0f,
              // CAMERA ROTATION SPEED
              30.0f},
          CAMERA_MOVEMENT_SPEED(CAMERA_DEFAULT_SPEEDS[0]), CAMERA_ROTATION_SPEED(CAMERA_DEFAULT_SPEEDS[1])
    {
    }

    void OrthographicCameraController::OnUpdate(_TIME deltatime)
    {
