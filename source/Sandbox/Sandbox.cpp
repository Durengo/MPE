...
public:
          ...
          SQ_SCALE(glm::scale(glm::mat4(1.0f), glm::vec3(SQ_VECTOR_SCALE) * SQ_SCALE_FACTOR))
    {
        ...
        float vertices[3 * 7] = {
            ...
            0.5f, -0.5f, 0.0f, 0.2f, 1.0f, 1.0f, 1.0f,
        ...
        vertexBuffer->SetLayout({{MPE::ShaderDataType::Vec3, "ATTR_POS"},
                                 {MPE::ShaderDataType::Vec4, "ATTR_COLOR"}});
        ...
        SQVB->SetLayout({{MPE::ShaderDataType::Vec3, "ATTR_POS"},
                         {MPE::ShaderDataType::Vec2, "ATTR_TEXCOORD"}});
